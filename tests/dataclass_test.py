...
from geoapps_utils.utils.importing import GroupData
...
def test_drillhole_groups(tmp_path):
    ...
    with Workspace(h5path) as workspace:
        ...
        assert input_file.drillholes.groupValue == drillhole_group
